# Contributing to UMBRA.chat

Thanks for your interest in contributing to UMBRA! This project aims to build post-quantum private chat with zero-knowledge verified personhood.
...
### Building
```bash
git clone https://github.com/umbra-chat/umbra.git
cd umbra
cargo build
cargo test
```
...
Report vulnerabilities to: security@umbra.chat (PGP key in SECURITY.md)
