...
**Note**: UMBRA is currently in alpha. Not production-ready.
...
Email: **security@umbra.chat** (or create private security advisory on GitHub)
...
```
TODO: Add PGP public key for security@umbra.chat
```
...
1. Reporter privately discloses to UMBRA team
